...
mod tests {
	...
	async fn metadata_test() {
		...
		let mut heals = 0i32;
		let mut count = 0;
		let mut tx = reader::tail_file("/games/Steam/steamapps/compatdata/1286830/pfx/drive_c/users/steamuser/Documents/Star Wars - The Old Republic/CombatLogs/combat_2023-12-25_08_01_46_124966.txt")
